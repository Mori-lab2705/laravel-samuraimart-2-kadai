...
use Goodby\CSV\Import\Standard\LexerConfing;
...
class ProductController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('iamge', __('Image'))->image();
        $grid->column('recomend_flag', __('Recommend Flag'));
        ...
        $grid->filter(function($filter){
            ...
            $filter->equal('recommen_flag', 'おすすめフラグ')->select(['0'=> 'false', '1' =>'true']);
    ...
    public function csvImport(Request $request)
    {
        ...
        $lexer_confing = new LexerConfing();
        $lexer = new Lexer($lexer_confing);

        $interpreter = new Interpreter();
        $interpreter->unscript();
