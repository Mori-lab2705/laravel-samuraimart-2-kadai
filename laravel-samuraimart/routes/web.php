...
Route::controller(UserController::class)->group(function () {
    ...
    Route::get('users/mypage/cart_history/{num}', 'cart_history_show')->name('mypage.cart_history_show')->name('mypage.cart_history_show');
    Route::get('usrs/mypage/register_card', 'register_card')->name('mypage.register_card');
...
Route::get('product/{product}/favoirte', [ProductController::class, 'favorite'])->name('products.favorite');
